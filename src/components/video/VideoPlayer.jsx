...
const VideoPlayer = ({ url, sections, onProgress }) => {
	...
	const playerHeight = window.innerHeight - 150;
	...
	return (
		<div
			className="w-screen bg-vid-player-bg"
		...
		>
			<div className="relative">
				<ReactPlayer
					...
					url={url}
					width={"100%"}
					height={isFullScreen ? playerHeight + 150 : playerHeight}
					onProgress={handleProgress}
					pip={true}
					className="relative p-40 w-full"
				/>
				{/* <div
			...
			{showControls && (
				<div
					className={`flex justify-between items-center gap-5 px-2 absolute  bg-vid-player-controls-bg w-full py-2 ${
						isFullScreen ? "-bottom-0" : "bottom-[150px]"
					}`}
				>
